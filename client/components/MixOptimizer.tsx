  ...
  return (
    <div className="flex flex-col gap-gutter">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-gutter items-start w-full">
        ...
        <div className="lg:col-span-4 flex flex-col gap-gutter w-full lg:sticky lg:top-[90px] lg:h-[calc(100vh-120px)] lg:overflow-y-auto lg:self-start z-20 pr-2 custom-scrollbar">
